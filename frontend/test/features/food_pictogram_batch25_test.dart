...
void main(){
 ...
 test('B25 appends three Saudi concepts after certified B24 baseline',(){expect(mealFoodCatalog.length,377);expect(mealFoodCatalog.take(374).length,374);expect(mealFoodCatalog.skip(374).map((e)=>e.id).toList(),ids);expect(mealFoodCatalog.map((e)=>e.id).toSet().length,377);});
