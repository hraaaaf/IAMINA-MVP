...
void main() {
  test('all fourteen pictogram batches cover the full 322-item catalog', () {
    final fullBatches = <Set<String>>[
    ...
    final batches = <Set<String>>[...fullBatches, codeFoodPictogramBatch14Ids];
