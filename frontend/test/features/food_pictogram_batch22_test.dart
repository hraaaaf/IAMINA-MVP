...
void main(){
 ...
 test('B22 remains the certified 368-item prefix after B23',(){expect(mealFoodCatalog.length,greaterThanOrEqualTo(368));expect(mealFoodCatalog.skip(365).take(3).map((e)=>e.id).toList(),ids);expect(mealFoodCatalog.take(368).map((e)=>e.id).toSet().length,368);});
