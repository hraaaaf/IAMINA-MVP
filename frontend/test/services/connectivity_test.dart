...
void main() {
  ...
  test('SyncService reports failure and increments attempts on batch rejection', () async {
    final testLog = LogEntryData(
      id: 1, createdAt: DateTime.now(), bloodSugar: 120,
      clientUuid: 'test-uuid', syncStatus: 'pending', source: 'manual',
      isSick: false, isStressed: false, isTired: false, isActive: false,
      ramadanMode: false, syncAttempts: 2, errorSync: false,
  ...
  test('SyncService is not re-entrant — second call while syncing is ignored', () async {
