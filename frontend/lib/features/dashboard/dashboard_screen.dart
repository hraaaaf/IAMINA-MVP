              ...
              children: [
                ...
                SizedBox(
                  ...
                  child: FilledButton.icon(
                    ...
                    label: Text(
                      AuditedPageCopy.of(context).l10n.addFirstMeasurement,
                      style: const TextStyle(
                        fontSize: 14,
                        fontWeight: FontWeight.w700,
                      ),
                ...
                SizedBox(
                  ...
                  child: OutlinedButton.icon(
                    ...
                    label: Text(
                      AuditedPageCopy.of(context).l10n.importDocument,
                      style: const TextStyle(
                        fontSize: 14,
          ...
          Wrap(
            ...
            children: [
              _FeaturePill(
                ...
                label: AuditedPageCopy.of(context).l10n.featureRealtimeAgp,
              ),
              _FeaturePill(
                icon: Icons.auto_awesome,
                label: AuditedPageCopy.of(context).l10n.featureAiAnalysis,
              ),
              _FeaturePill(
                icon: Icons.shield_outlined,
                label: AuditedPageCopy.of(context).l10n.featurePrivateData,
              ),
            ],
          ),
        ],
