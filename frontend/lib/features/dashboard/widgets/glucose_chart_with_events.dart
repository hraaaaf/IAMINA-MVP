      ...
      return ClinicalCard(
        ...
        child: Column(
          children: [
            ...
            const Text(
              'Aucune donnée',
              style: TextStyle(color: AminaTheme.ink400, fontSize: 13),
            ),
            const SizedBox(height: 40),
          ],
        ),
          ...
          Padding(
            ...
            child: Row(
              children: [
                Expanded(
                  child: CardHead(
                    title: 'Profil glycémique ambulatoire',
                    meta: widget.unit,
                  ),
                ),
                // Live badge
            ...
            const SizedBox(
              ...
              child: Center(
                child: Text(
                  ...
                  style: TextStyle(fontSize: 12, color: AminaTheme.ink400),
                ),
              ),
            ),
