                  ...
                  children: [
                    CircularProgressIndicator(
                      ...
                      valueColor: AlwaysStoppedAnimation<Color>(
                        isGood ? AminaTheme.teal500 : AminaTheme.warningOrange,
                      ),
                  ...
                  children: [
                    Text(
                      ...
                      style: TextStyle(
                        fontSize: 14,
                        fontWeight: FontWeight.w700,
                        color: isGood ? AminaTheme.teal600 : AminaTheme.warnFg,
                      ),
                    ),
                    const SizedBox(height: 3),
                    Text(
                      isGood
                          ? 'Objectif <36% atteint. Variabilité maîtrisée.'
                          : 'Variabilité élevée. Objectif < 36%.',
                      style: TextStyle(
                        fontSize: 11,
