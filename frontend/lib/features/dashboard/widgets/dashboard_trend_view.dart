...
class DashboardTrendShell extends StatelessWidget {
  final int? count;
  final String subtitle;
  final Widget child;

  const DashboardTrendShell({
    super.key,
    required this.count,
...
class DashboardTrendSummary extends StatelessWidget {
...
class DashboardTrendRangeSelector extends StatelessWidget {
  final List<String> labels;
  final int selectedIndex;
  final ValueChanged<int> onChanged;

  const DashboardTrendRangeSelector({
    super.key,
...
class DashboardTrendPlot extends StatelessWidget {
...
class DashboardTrendLegend extends StatelessWidget {
  final String unit;
  final double? low;
  final double? high;
  final bool dailySummary;
...
class DashboardTrendSelectionCard extends StatelessWidget {
  final LogEntryData log;
  final String unit;
  final String locale;

  const DashboardTrendSelectionCard({
    super.key,
    required this.log,
    required this.unit,
    required this.locale,
...
class DashboardTrendState extends StatelessWidget {
  final bool loading;
  final IconData? icon;
  final String text;

  const DashboardTrendState({
    super.key,
    this.loading = false,
    this.icon,
    required this.text,
