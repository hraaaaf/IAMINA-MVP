          ...
          child: ConstrainedBox(
            ...
            child: Column(
              children: [
                ...
                _DemoButton(
                  isLoading: _isLoading,
                  onTap: () => _handleLogin(isDemo: true),
                ),
      ...
      children: [
        Container(
          ...
          decoration: BoxDecoration(
            ...
            boxShadow: [
              BoxShadow(
                color: AminaTheme.teal500.withValues(alpha: 0.25),
                blurRadius: 16,
                offset: const Offset(0, 6),
              ),
            ],
          ),
          child: CustomPaint(painter: _GlucoseCurvePainter()),
        ),
        const SizedBox(height: 20),
        Text(
          l10n.appTitle,
        ...
        Row(
          children: [
            ...
            Padding(
              ...
              child: Text(
                l10n.or,
                style: const TextStyle(fontSize: 12, color: AminaTheme.ink400),
              ),
            ),
            const Expanded(child: Divider(color: AminaTheme.ink200)),
          ],
