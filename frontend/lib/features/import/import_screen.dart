...
class _ImportScreenState extends State<ImportScreen> {
  ...
  void _showComingSoon(String name) {
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
        content: Text(
          '$name arrive bientôt — rejoignez la liste d\'attente dans Profil.',
        ),
              ...
              child: Column(
                ...
                children: [
                  ...
                  _ImportOption(
                    ...
                    title: 'Dexcom G6/G7',
                    subtitle:
                        'Connexion directe via Dexcom CLARITY. Synchronisation automatique toutes les 5 minutes.',
                    badge: 'BIENTÔT',
                  ...
                  _ImportOption(
                    ...
                    subtitle:
                        'Import des données LibreView via CSV ou connexion API.',
                    badge: 'BIENTÔT',
                    badgeBg: AminaTheme.ink50,
                    badgeFg: AminaTheme.ink500,
                    action: OutlinedButton(
