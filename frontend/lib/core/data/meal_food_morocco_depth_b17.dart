...
const List<MealFoodItem> moroccoDepthB17FoodCatalog = <MealFoodItem>[
  ...
  MealFoodItem('chebakia','Chebakia','Chebakia','الشباكية',aliases:<String>['chabakia','chebbakia','griwech','mkharqa','شباكية'],category:MealFoodCategory.sweetDessert,regions:const <MealFoodRegion>{MealFoodRegion.morocco},moments:const <MealFoodMoment>{MealFoodMoment.snack},visual:'🍯'),
