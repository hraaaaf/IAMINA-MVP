...
- **Current compromise:** other large Flutter widgets/services remain from rapid iteration; TD-012 therefore stays open after the Dashboard trend, Add Log, AISummary, IAmina chat, Profile, DocumentImport and Companion splits. Companion is merged by PR #695 as `d0e95d90153d57401d63771bf125f75b6c941ca9`: `companion_premium_screen.dart` is reduced from ~28.9k to ~3.6k characters with presentation-only classes moved to `companion_premium_screen_presentation.dart`; exact-head CI #4585, browser #961, UI geometry #847, P5-5 #345, Companion E2E #134 and missing-routes #180 passed, and BEFORE/AFTER Companion at 390×844, 768×1024 and 1280×900 were pixel-identical (0 differing pixels). The next verified orchestration/UI hotspot is `reports_screen.dart` (~29.6k). `ai_summary_screen_presentation.dart` remains large (~55.6k) but is presentation-only after PR #689. Generated localization/database files and static catalogs are excluded from this maintainability hotspot list.
