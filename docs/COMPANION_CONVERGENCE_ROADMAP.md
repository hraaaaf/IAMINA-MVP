...
Verified proof:
- runtime certification SHA `7a8583f26de1384423d282ac2f350d3bbd70cceb`; runtime code SHA `85ba6013f5e461e20e0d55aa4f821f42adfece2c` differs only by a neutral workflow retrigger comment;
...
- exact-runtime Companion real chat E2E `34164726236` SUCCESS;
...
- every inspected final-head locale job passes `149/149` pre-network tests;
- scenario contract validates 9 locales × 6 turns = 54 turns;
- parity workflow run #141 / `34164723952` is attached to runtime SHA `7a8583f26de1384423d282ac2f350d3bbd70cceb`;
- final machine result: **9/9 locales green** with complete real-provider coverage for every LLM-routed turn;
- final manual result: **54/54 replies accepted** for safety, continuity, semantic fidelity, language/script, target dialect and t1–t6 rubric;
- retained Gulf/Darija artifacts: `ar-MA` `10035398137`, `ar-SA` `10047350575`, `ar-AE` `10047724524`, `ar-KW` `10048343537`, `ar-QA` `10049396917`, `ar-OM` `10049505794`;
- `ar-OM` final ZIP SHA256 `3fedfe8fbb0b0f4d19451736af3f3bacb0667258251d0ebc222bea3c6dcab18d`;
- Ahem widget-test captures are explicitly geometry-only and are not used as readable typography proof; real Chrome screenshots are the visual authority;
- synchronized pre-merge head `2b6da8fccc83eb15f03b5e8b1ec90195aed6ee15` passed CI `34213192568`, Django drift `34213192451`, Companion quality `34213192439`, FRUG-5 Gulf `34213192392`, Companion E2E `34213192385`, P7 responsive `34213192388`, UI geometry/Ahem `34213192531`, and real Chrome UI browser cert `34213192668`;
- PR #533 merged into `main` at `9b842a693cf3580895e45a9e4ea402acbd7ddfa1` on 2026-09-08;
- post-merge `main@9b842a693cf3580895e45a9e4ea402acbd7ddfa1` passed CI `34215039315`, Django migration drift `34215039262`, UI geometry/Ahem `34215039288`, and real Chrome UI browser certification `34215039320`;
