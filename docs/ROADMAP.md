...
> **Last updated:** 2026-08-12 — UX visual rebase is closed through UX-11: Dashboard action + visual parity reached **9.8/10** against the approved reference; PR #110 merged as `8e45474ba5fab607783fa07750a268592b76875a` and post-merge CI #1704 + drift #1516 are green.
>
...
| UX visual rebase | 100% | ✅ Closed | UX-0–10 remain closed; UX-11 PR #110 aligned real Dashboard actions and the populated mobile composition with the approved reference at **9.8/10** (merge `8e45474ba5fab607783fa07750a268592b76875a`); post-merge CI #1704 + drift #1516 green |
...
**UX-8 closeout:** PR #99 centralized route, auth, sidebar and floating mobile-navigation motion through the shared `AminaMotion` system while preserving routes, information architecture, clinical logic and data behavior. Normal motion uses the certified shared timing/curve language; `MediaQuery.disableAnimations` and `accessibleNavigation` resolve interactive durations to zero and route transitions return the child directly. Exact product head `9f8bd4e6e4427e6ec6d7d8dced9936b5abec3ccc` passed CI #1528 / run `31473040255` and migration drift #1340 / run `31473040166`. Fresh motion audit run `31473403273` succeeded with artifact `9094314882`, digest `sha256:e63065c47dbdc050a46fc713103b05100e5a335a824c950cd34bd6ecdb168a81`, FR/AR normal + reduced-motion coverage, four recorded videos plus intermediate/final stills, 20/20 routed states, exactly one `flutter-view`, zero page errors and Product/UX **9.6/10**. Accessibility/Reduced Motion review was FINAL PASS and Release Certifier authorized the expected-head merge. PR #99 merged as `bdb19726245ff5b059bb69883ee628407a7f88b4`; post-merge CI #1529 / run `31477006947` and migration drift #1341 / run `31477006987` both passed. **UX-8 is 100% closed.** This UX work does not change the MENA critical-path numerator.

**UX-9 closeout:** PR #101 recomposed the populated Dashboard without changing clinical calculations, persistence, routes, sync semantics, consent or AI safety behavior. Mobile now leads with IAmina identity, greeting/context, a truthful latest-reading hero with a real persisted-data sparkline, and one compact TIR/GMI/CV trends surface; desktop retains the detailed analytical cards. Fresh rendered audit run `31486722900` succeeded with artifact `9099498470`, digest `sha256:24571edfab9a10e3cce9a3d91f33c7596fc444f1a5e3dd7fe924f8ad723bd0a8`, six FR/AR captures across 390×844, 360×560 and 1440×1000, exactly one `flutter-view`, zero page errors and Product/UX **9.5/10**. Exact product head `a3684d03099e4502f0a2fdee1c63f0ea42a960df` passed CI #1536 / run `31487182393` and migration drift #1348 / run `31487182456`; PR #101 merged as `662b6ce80695846e28788452ddc165e6ad9c8d07`; post-merge CI #1537 / run `31487410893` and migration drift #1349 / run `31487410839` both passed. **UX-9 is 100% closed.** This UX work does not change the MENA critical-path numerator.
...
6. **UX product-quality lane:** UX visual rebase is closed through UX-8. Do not open another UX remediation LOT unless fresh rendered evidence exposes a new <=9.0 state or a new requirement changes a certified surface.
