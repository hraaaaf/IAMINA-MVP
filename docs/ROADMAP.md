...
- TD-012 remains OPEN. AISummary phase 2 is merged by PR #689 / `fe73ebc656f1d45903e1e01c3f903556fa79ae8d`, reducing `ai_summary_screen.dart` from ~47.5k to ~4.4k characters by moving the remaining UI classes into `ai_summary_screen_presentation.dart`; exact-head CI #4564, geometry #837, Offline UI #92 and P5-5 #328 succeeded, while browser #944 was still running at merge time under explicit owner authorization. IAmina chat remains CLOSED by PR #671 / `ddaec2952be4f102807476ed55562bf4f6973958`; Profile remains CLOSED by PR #675 / `0c805e5ffd92b8d918be4dd2155aca530bd96b6a`. Next verified handwritten hotspot: `document_import_screen.dart` (~31.2k).
...
- main reconciled for this lot: `fe73ebc656f1d45903e1e01c3f903556fa79ae8d`
