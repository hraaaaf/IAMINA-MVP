...
`P5-1/P5-3 human evidence where selected pilot scope requires it → P5-6 external release authorization → P5-7 observed pilot evidence → P5-8 go/no-go`
...
**Pilot Readiness progress: 3/9 = 33.3%.** Closed whole lots remain P5-0, P5-2 and P5-5. P5-4A is a closed sub-lot, but P5-4 remains split/open because P5-4B is deferred; therefore the P5 numerator does not change. P5-6 remains blocked on external/human release evidence. This metric is separate from the 32/38 MENA numerator.
