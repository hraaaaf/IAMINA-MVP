...
start = s.index('### P0-JOURNAL-2 durable closeout contract')
end = s.index('\n---\n\n# P0 visual UX remediation', start)
section = '''### P0-JOURNAL-2 durable closeout contract
...
Path('status-Achraf.md').write_text('''# IAmina — Current Status for Achraf
...
Path('status.md').write_text('''# IAmina — Session Status
