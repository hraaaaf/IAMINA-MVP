...
# --- Summary: responsive wide error state -------------------------------------
...
# --- Profile: harmonized desktop grouping and section surfaces ----------------
...
if old not in s:
    raise SystemExit('profile root block not found')
...
p = root / 'test/p2_ux_14_density_polish_contract_test.dart'
...
void main() {
  test('summary error uses a proportionate wide composition without harming mobile', () {
  ...
  test('journal wide empty state stays attached to the readable content region', () {
  ...
  test('profile desktop groups progressive sections with shared clinical surfaces', () {
    ...
    expect(source, isNot(contains('borderRadius: BorderRadius.circular(18)')));
  });
