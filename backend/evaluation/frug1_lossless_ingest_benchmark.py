...
def run_frug1_lossless_benchmark(
        ...
        cases.append(
            {
                ...
                "baseline_numeric_ok": baseline_numbers == expected_numbers,
                "minimized_numeric_ok": minimized_numbers == expected_numbers,
                "numeric_preserved": numeric_preserved,
                "numeric_regression": not numeric_preserved,
            }
        )
...
def main() -> int:
    ...
    report = run_frug1_lossless_benchmark(
        payload,
        source,
