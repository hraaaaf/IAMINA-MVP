...
def test_forbidden_term_matching_is_token_bounded_not_substring_based():
    assert machine_review(_case("en"), "Tomorrow is another opportunity to restart calmly.")["no_advice_terms"] is True
