...
- Sans autorisation: aucune action santé/comportementale, y compris activité physique, alimentation, sommeil et hydratation. Organisation abstraite: n'invente ni horaire/fréquence.
