"""Focused tests for public-demo model selection and language prompt boundaries."""
...
class DemoModelSelectionTests(SimpleTestCase):
    @override_settings(GROQ_API_KEY="test", GROQ_BASE_URL="https://example.invalid")
    @patch.dict(
        os.environ,
        {
            "IAMINA_DEMO_EXTERNAL_AI_ENABLED": "true",
            "IAMINA_DEMO_LLM_PROVIDER": "groq",
            "IAMINA_DEMO_LLM_MODEL": "allam-2-7b",
        },
        clear=False,
    )
